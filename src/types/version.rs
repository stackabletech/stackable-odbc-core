...
///   silently substitutes `0`, which is indistinguishable from that component
///   being genuinely absent. `"3.99999999999.1"` therefore parses as
...
mod tests {
    ...
    /// field. Widening is the only lossless option, because truncating "467" to
    /// "67" would report a different server.
    #[test]
